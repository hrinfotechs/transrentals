...
class SharedPreferenceHelper {
  ...
  Future<void> saveUserModel(User value) async {
    await _sharedPreference.setString(PrefKeys.userModel, jsonEncode(value));
  }

  User get loggedInUser {
    String? str = _sharedPreference.getString(PrefKeys.userModel);
