...
class BankTransferEditDetailsWidget extends GetWidget<ProfileController> {
  @override
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            controller: controller.bankTransferNameTextController,
          ...
          TextField(
            controller: controller.bankTransferAccNoTextController,
          ...
          TextField(
            controller: controller.bankTransferIFSCCodeTextController,
            keyboardType: TextInputType.text,
            textCapitalization: TextCapitalization.words,
            textInputAction: TextInputAction.next,
            style: AppTextStyles.textStyleRegular.copyWith(
          ...
          TextField(
            controller: controller.bankTransferBankNameTextController,
            keyboardType: TextInputType.text,
            textCapitalization: TextCapitalization.words,
            textInputAction: TextInputAction.next,
            style: AppTextStyles.textStyleRegular.copyWith(
          ...
          DropDownTextField(
            ...
            initialValue:
                controller.bankTransferAccTypeTextController.value.text,
            onChanged: (value) {
              controller.bankTransferAccTypeTextController.value.text =
          ...
          TextField(
            controller: controller.bankTransferBranchTextController,
            keyboardType: TextInputType.text,
            textCapitalization: TextCapitalization.words,
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      FocusManager.instance.primaryFocus?.unfocus();
                      controller.updateBankTransferDetails();
                    },
                    style: ButtonStyle(
